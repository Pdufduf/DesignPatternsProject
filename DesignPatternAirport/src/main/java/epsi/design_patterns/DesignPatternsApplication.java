...
public class DesignPatternsApplication {
	...
	@Bean
	public CommandLineRunner airport(AeroportRepository repository, VolRepository volRepository, ClientRepository clientRepository, BilletRepository billetRepository) {
		return (args) -> {
